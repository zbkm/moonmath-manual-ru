...
%fonts
% tempora provides Times-like font with cyrillic support
\usepackage{tempora}
...
\newcommand{\defname}{определение}%word used for cross-referencing definitions in the text
\newcommand{\defvsep}{\hspace{0ex}\newline{}\vspace{-4ex}}% vertical space after definitions that start with a list
\newtheorem{conjecture}{Гипотеза}
\newtheorem{remark}{Замечание}
\newtheorem{notation}{Обозначения и символы}

% Examples get their own counter
\newcounter{ExampleCounter}
\newtheorem{example}[ExampleCounter]{Пример}


% Exercises get their own counter
\newcounter{ExerciseCounter}
\newtheorem{exercise}[ExerciseCounter]{Упражнение}

% Jargon get their own counter
\newcounter{JargonCounter}
\newtheorem{jargon}[JargonCounter]{Термин}
...
\newcommand{\examplename}{пример}%word used for cross-referencing examples in the text
\newcommand{\secname}{раздел}%word used for cross-referencing (sub)*sections in the text
\newcommand{\chaptname}{глава}%word used for cross-referencing chapters in the text
\newcommand{\algname}{алгоритм}%word used for cross-referencing algorithms in the text
\newcommand{\exercisename}{упражнение}%word used for cross-referencing excercises in the text
\newcommand{\notationname}{обозначение}%word used for cross-referencing notations in the text
